...
> **Amended 2026-09-23 by [DEC-010](DEC-010-oracle-phase0-handoff-autonomy.md)** (provisioned) **and [DEC-011](DEC-011-cursor-oracle-access-cf-tunnel.md)** (access **LIVE**). Always Free **2 OCPU / 12 GB** envelope, JSONL EXP spine, and paper/no-keys rules **remain**. Live inventory + autonomy: [ORACLE-PHASE0-HANDOFF.md](../ARTIFACTS/ORACLE-PHASE0-HANDOFF.md). Original pre-create text below is **historical** except where still true (sizing, cheap-first, JSONL spine).
...
| **Amended by** | [DEC-010](DEC-010-oracle-phase0-handoff-autonomy.md) (pending → provisioned); [DEC-011](DEC-011-cursor-oracle-access-cf-tunnel.md) (access path **LIVE** 2026-09-23) |
...
7. **Laptop role:** operator console + **data courier**. Laptop is **not** the 24/7 observe host. **Human PC must not** become a permanent Cursor→Oracle networking hop ([DEC-011](DEC-011-cursor-oracle-access-cf-tunnel.md) **LIVE** 2026-09-23).
...
- **Provision complete (2026-09-23).** Access **LIVE** ([DEC-011](DEC-011-cursor-oracle-access-cf-tunnel.md)); observe/paper bootstrap on `/var/lib/mal`.
