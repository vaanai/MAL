...
- **Phase-0 host** — Oracle Always Free `mal-core-0` (**2 OCPU / 12 GB A1**, **provisioned and verified**); Cursor↔Oracle access **DEC-011 decided, pending owner implement** (agents do **not** yet have SSH); laptop = operator + data courier (not a permanent networking hop)  
...
- [Oracle Phase-0 handoff](ARTIFACTS/ORACLE-PHASE0-HANDOFF.md) — live inventory, autonomy laws; access design [DEC-011](DEC/DEC-011-cursor-oracle-access-cf-tunnel.md) (**pending owner implement**) 
