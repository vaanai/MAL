...
7. **EXP-005 Scout Discovery (Proposed, not run):** Smart-wallet / follow **L3** path — [EXP-005](EXP/EXP-005-smart-wallet-follow-discovery-v0.md) docs-only; same sealed 20/21 courier law as EXP-004; **no ordinal / H-G2 revive**; Graph stays EXP-004/004b.
