...
8. **EXP-006 paper fill-sim (scored 2026-09-23):** Helm/Vaan **2026-09-23** authorized unpark — P0 **`tools.exp006_paper_fill_sim`** on sealed **2026-09-20/21** (`mal-core-vnic`; host `_exp006-oracle-*`). Cross-day **INCOMPLETE** — primary **L3_minus_v2** **K-lift-rescue FAIL** day **20** / **PASS** day **21** @60s; fill_rate **100%**; priced_n **14**/**11** @60s; **no Discovery promote**. Scout soft PASS pending; **Proof GATE**. [EXP-006](EXP/EXP-006-paper-would-have-happened-harness-v0.md).
