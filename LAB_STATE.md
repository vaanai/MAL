...
- **Platform-regime taxonomy (bonding-first v0):** **EXP-007** sealed **coverage / knowable-at-T** audit **2026-09-23** on courier **2026-09-20/21** → cross-day **INCOMPLETE** (structural gates **PASS**; **K-platform-rpc-resolved INCOMPLETE** — 100% WS defaults). **EXP-007b** — capped (≤500/day) RPC `regime_enrich` + audit re-score; **EXP-007c** — fee-at-T restamp on **same** 007b sample (**K-fee-knowable-at-T INCOMPLETE**; Global **95 bps** ≠ `global_100bps`). **Wiring / encoder still Proposed** — merge ≠ continuous observe-wiring. [EXP-007](EXP/EXP-007-platform-regime-taxonomy-v0.md) · [EXP-007b](EXP/EXP-007b-platform-regime-rpc-enrich-v0.md) · [EXP-007c](EXP/EXP-007c-fee-knowable-at-t-v0.md); enum [REGIME-ENUM-V0.md](ARTIFACTS/REGIME-ENUM-V0.md).
