...
- **Platform-regime taxonomy (bonding-first v0):** **EXP-007** sealed **coverage / knowable-at-T** audit **2026-09-23** on courier **2026-09-20/21** → cross-day **INCOMPLETE** (structural gates **PASS**; **K-platform-rpc-resolved INCOMPLETE** — 100% WS defaults). **EXP-007b** — capped (≤500/day) RPC `regime_enrich` + audit re-score; **EXP-007c** — fee-at-T restamp (**K-fee-knowable-at-T INCOMPLETE** under v0 enum; Global **95 bps**); **EXP-007d** — **Proposed** `global_95bps` + decode-only re-score → **K-fee-knowable-at-T PASS** (0% `unverified` on sample; sealed book fee unchanged). **Wiring / encoder still Proposed** — merge ≠ continuous observe-wiring. [EXP-007](EXP/EXP-007-platform-regime-taxonomy-v0.md) · [EXP-007b](EXP/EXP-007b-platform-regime-rpc-enrich-v0.md) · [EXP-007c](EXP/EXP-007c-fee-knowable-at-t-v0.md) · [EXP-007d](EXP/EXP-007d-fee-global-95bps-enum-v0.md); enum [REGIME-ENUM-V0.md](ARTIFACTS/REGIME-ENUM-V0.md).
