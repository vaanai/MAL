...
- **Platform-regime taxonomy (bonding-first v0):** **EXP-007** sealed **coverage / knowable-at-T** audit **2026-09-23** on courier **2026-09-20/21** → cross-day **INCOMPLETE** (structural gates **PASS**; **K-platform-rpc-resolved INCOMPLETE** — 100% WS defaults). CLI [`tools.exp007_regime_audit`](tools/exp007_regime_audit.py); host `_exp007-oracle-2026-09-20_21`. **Wiring / encoder still Proposed** — merge ≠ continuous observe-wiring. [EXP-007](EXP/EXP-007-platform-regime-taxonomy-v0.md); enum [REGIME-ENUM-V0.md](ARTIFACTS/REGIME-ENUM-V0.md).
