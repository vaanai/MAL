...
| [EXP-006](EXP-006-paper-would-have-happened-harness-v0.md) | Paper “would-have-happened” fill harness v0 (P0) | **Proposed, not run** (docs registration only) | Watch-list cohorts (v2 runners + **L3_minus_v2**); merge ≠ authorize-run; no CLI in registration PR |
| [EXP-007](EXP-007-platform-regime-taxonomy-v0.md) | Platform-regime taxonomy v0 (curve version / fees / graduation / quote) | **Proposed, not run** (docs registration only) | Scout owns labels; Proof enforces stratify/gate; merge ≠ authorize-run; no observe CLI in registration PR |
