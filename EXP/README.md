...
| [EXP-007b](EXP-007b-platform-regime-rpc-enrich-v0.md) | Platform-regime RPC enrich + audit re-score (capped sample) | **Running** (Helm 2026-09-23) | Knowable-at-T `regime_enrich` + enriched-sample gates; merge ≠ continuous observe-wiring |
