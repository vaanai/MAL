...
| [EXP-007d](EXP-007d-fee-global-95bps-enum-v0.md) | Proposed `global_95bps` enum + fee gate re-score (reuse 007c) | **PASS (K-fee)** / **Proposed enum** (Oracle 2026-09-20/21) | **K-fee-knowable-at-t PASS** (0% `unverified`); **85.6%** / **89.4%** `global_95bps`; enriched composite **INCOMPLETE**; merge ≠ wiring |
