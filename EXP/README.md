...
| [EXP-002b](EXP-002b-evaluate-rules-v1.md) | Evaluate→runner rules v1 (stricter) | **INCOMPLETE closed** locally (~81% reject; marks pending) | Pending lift after EXP-003 marks |
