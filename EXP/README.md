...
| [EXP-006](EXP-006-paper-would-have-happened-harness-v0.md) | Paper “would-have-happened” fill harness v0 (P0) | **INCOMPLETE (scored)** (Oracle 2026-09-20/21 sealed) | P0 CLI + paper_fill side JSONL; primary **L3_minus_v2** **K-lift-rescue** split; **no promote** |
