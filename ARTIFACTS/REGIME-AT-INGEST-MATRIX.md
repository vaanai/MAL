...
- [ ] Proof EXP: mis-label rate on 100 creates (stratified when volume allows) — [EXP-001](../EXP/EXP-001-regime-stage-mislabel.md)

Until 24h capture + EXP-001 scoring complete, **observe-wiring** is code-complete but not measurement-validated.
