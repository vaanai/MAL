...
| **Status** | **Proposed** paper registration (2026-09-24). **Soft GATE Formal still pending** (FAIL #1–#4 schema/CLI holes closed on branch; no PASS claim). Not a measure. Not a host run. |
