...
- **EXP-005b:** Residual **L3_minus_v2** falsifier after #37 — **Proposed, not run** (does L3 add beyond EXP-002c v2-runner slice?). [EXP-005b](../EXP/EXP-005b-l3-residual-vs-exp002c-v2-falsifier-v0.md).
