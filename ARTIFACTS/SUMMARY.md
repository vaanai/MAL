...
- **EXP-004:** Graph Discovery tooling **landed** — `python -m tools.exp004_graph_discovery` (H-G1…H-G4, regime-gated as-of-T vs spine; gates + DATA BLOCKER). **No scored lift in cloud** (no courier JSONL). Operator runs on laptop/Oracle JSONL + existing marks. [EXP-004](../EXP/EXP-004-graph-creator-recurrence-v0.md); [GRAPH-DISCOVERY-V0.md](GRAPH-DISCOVERY-V0.md) §9.
