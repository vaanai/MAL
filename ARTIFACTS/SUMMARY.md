...
- **EXP-004b:** **NH-G1a** ordinal prior-mint depth — **Proposed, not run** (Graph child; same sealed 20/21 JSONL when executed). H-G2 kill intact. [EXP-004b](../EXP/EXP-004b-nh-g1a-ordinal-prior-mint-v0.md).
