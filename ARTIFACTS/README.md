...
| [PAPER-FILL-SIM-SCOREBOARD-SEALED-FIXTURE-V0.md](PAPER-FILL-SIM-SCOREBOARD-SEALED-FIXTURE-V0.md) | Proposed fill-sim scoreboard over local `paper_fill_sim_hot_packet_evaluate_v0` stamps and a synthetic sealed-day expectation; Soft GATE **pending** + [paper-fill-sim-scoreboard-sealed-fixture-v0.schema.json](paper-fill-sim-scoreboard-sealed-fixture-v0.schema.json) |
