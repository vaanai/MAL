...
| [PAPER-LAYA-RISK-GATE-LOCK-RECEIPT-V0.md](PAPER-LAYA-RISK-GATE-LOCK-RECEIPT-V0.md) | Proposed LAYA risk-gate **lock** receipt: cites #63/#64 surround fixtures; `risk_gate.decision=locked`; fixtures `fixtures/paper_laya_risk_gate_lock_receipt_v0/`; CLI `python -m tools.paper_laya_risk_gate_lock_receipt_v0`; Soft GATE **pending** + [paper-laya-risk-gate-lock-receipt-v0.schema.json](paper-laya-risk-gate-lock-receipt-v0.schema.json); [LAB_STATE.md](../LAB_STATE.md) §11p |
