...
| [PAPER-LAYA-PRECOMPUTE-DECISION-PACKET-V0.md](PAPER-LAYA-PRECOMPUTE-DECISION-PACKET-V0.md) | Proposed LAYA precompute **decision packet**: cites #63/#64 surround fixtures + #65 lock receipts; `risk_gate.decision=locked`; fixtures `fixtures/paper_laya_precompute_decision_packet_v0/`; CLI `python -m tools.paper_laya_precompute_decision_packet_v0`; Soft GATE **PASS** (Formal #67; kill `bc-84b8db98-a158-5530-8e30-9e33587231fa`; head `f2e4508`) + [paper-laya-precompute-decision-packet-v0.schema.json](paper-laya-precompute-decision-packet-v0.schema.json); [LAB_STATE.md](../LAB_STATE.md) §11r |
