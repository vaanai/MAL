...
| [PAPER-LAYA-PRECOMPUTE-SURROUND-PACKET-V0.md](PAPER-LAYA-PRECOMPUTE-SURROUND-PACKET-V0.md) | Proposed LAYA precompute surround (non-fill-sim spine): #51 scoreboard digests ± optional #52 batch rollup; fixtures `fixtures/paper_laya_precompute_surround_packet_v0/`; CLI `python -m tools.paper_laya_precompute_surround_packet_v0`; Soft GATE **PASS** (kill `bc-40cf0f7a-1530-5934-8c60-c2554ccf3d66`; Formal #64 squash `277a142`) + [paper-laya-precompute-surround-packet-v0.schema.json](paper-laya-precompute-surround-packet-v0.schema.json); [LAB_STATE.md](../LAB_STATE.md) §11o |
| [PAPER-LAYA-RISK-GATE-LOCK-RECEIPT-V0.md](PAPER-LAYA-RISK-GATE-LOCK-RECEIPT-V0.md) | Proposed LAYA risk-gate **lock** receipt: cites #63/#64 surround fixtures; `risk_gate.decision=locked`; fixtures `fixtures/paper_laya_risk_gate_lock_receipt_v0/`; CLI `python -m tools.paper_laya_risk_gate_lock_receipt_v0`; Soft GATE **PASS** (Formal #65 squash `7979988`; kill `bc-aafaf4ca-d06f-5b11-b5cc-ca3f2ababd80`) + [paper-laya-risk-gate-lock-receipt-v0.schema.json](paper-laya-risk-gate-lock-receipt-v0.schema.json); [LAB_STATE.md](../LAB_STATE.md) §11p |
| [PAPER-LAYA-INCOMPLETE-RPC-HONESTY-SCHEMA-ALIGN-V0.md](PAPER-LAYA-INCOMPLETE-RPC-HONESTY-SCHEMA-ALIGN-V0.md) | Proposed LAYA schema-align pass: #63–#65 JSON Schemas refuse the dishonest shapes those CLIs already refuse. Soft GATE **PASS** (Formal #66 squash `3128128`; kill `bc-b59bd3fd-d786-5475-83f6-02f421b95098`; head `81be82c`). `schema_looser_than_cli` closed for watched LAYA shapes. No new runtime object |
| [PAPER-LAYA-PRECOMPUTE-DECISION-PACKET-V0.md](PAPER-LAYA-PRECOMPUTE-DECISION-PACKET-V0.md) | Proposed LAYA precompute **decision packet**: cites #63/#64 surround fixtures + #65 lock receipts; `risk_gate.decision=locked`; fixtures `fixtures/paper_laya_precompute_decision_packet_v0/`; CLI `python -m tools.paper_laya_precompute_decision_packet_v0`; Soft GATE **PASS** (Formal #67 squash `52a06e7`; kill `bc-84b8db98-a158-5530-8e30-9e33587231fa`; head `f2e4508`) + [paper-laya-precompute-decision-packet-v0.schema.json](paper-laya-precompute-decision-packet-v0.schema.json); [LAB_STATE.md](../LAB_STATE.md) §11r |
| [PAPER-LAYA-DECISION-PACKET-SCOREBOARD-SEALED-FIXTURE-V0.md](PAPER-LAYA-DECISION-PACKET-SCOREBOARD-SEALED-FIXTURE-V0.md) | Proposed LAYA **decision-packet scoreboard**: local validated #67 packets vs synthetic sealed-day expectation; both spines retained; Soft GATE **PASS** (Formal #68 squash `d31af86`; kill `bc-2fd452de-34a6-5c47-8076-3840fb2b6af7`; head `e52fb49`) + [paper-laya-decision-packet-scoreboard-sealed-fixture-v0.schema.json](paper-laya-decision-packet-scoreboard-sealed-fixture-v0.schema.json); CLI `python -m tools.paper_laya_decision_packet_scoreboard_sealed_fixture_v0`; [LAB_STATE.md](../LAB_STATE.md) §11s |
| [PAPER-LAYA-DECISION-PACKET-BATCH-ORACLE-SEALED-DAY-INCOMPLETE-RPC-V0.md](PAPER-LAYA-DECISION-PACKET-BATCH-ORACLE-SEALED-DAY-INCOMPLETE-RPC-V0.md) | Proposed LAYA **decision-packet batch**: synthetic `2026-09-20`/`2026-09-21` manifests → #67 packets → #68 scoreboard path; Soft GATE **PASS** (Formal #69 squash `adadaa8`; kill `bc-5e4e8d4d-c120-59ce-915f-43ee1d7eedf1`; fix `bc-dd6817fa-6217-5dca-86b1-0449370f5d29`; head `e13fbd7`) + [paper-laya-decision-packet-batch-oracle-sealed-day-incomplete-rpc-v0.schema.json](paper-laya-decision-packet-batch-oracle-sealed-day-incomplete-rpc-v0.schema.json); CLI `python -m tools.paper_laya_decision_packet_batch_oracle_sealed_day_incomplete_rpc_v0`; [LAB_STATE.md](../LAB_STATE.md) §11t |
| [PAPER-LAYA-DECISION-PACKET-BATCH-HOST-LOCAL-SEALED-JSONL-DRY-RUN-INCOMPLETE-RPC-V0.md](PAPER-LAYA-DECISION-PACKET-BATCH-HOST-LOCAL-SEALED-JSONL-DRY-RUN-INCOMPLETE-RPC-V0.md) | Proposed LAYA **decision-packet batch dry-run receipt**: operator-local shape for #69 parent on `mal-core-vnic`; Soft GATE **PASS** (Formal #70 squash `d020fc9`) + [paper-laya-decision-packet-batch-host-local-sealed-jsonl-dry-run-incomplete-rpc-v0.schema.json](paper-laya-decision-packet-batch-host-local-sealed-jsonl-dry-run-incomplete-rpc-v0.schema.json); CLI `python -m tools.paper_laya_decision_packet_batch_host_local_sealed_jsonl_dry_run_incomplete_rpc_v0`; [LAB_STATE.md](../LAB_STATE.md) §11u |
