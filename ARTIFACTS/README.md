...
| [PAPER-LAYA-DECISION-PACKET-SCOREBOARD-SEALED-FIXTURE-V0.md](PAPER-LAYA-DECISION-PACKET-SCOREBOARD-SEALED-FIXTURE-V0.md) | Proposed LAYA **decision-packet scoreboard**: local validated #67 packets vs synthetic sealed-day expectation; both spines retained; Soft GATE **PASS** (Formal #68; kill `bc-2fd452de-34a6-5c47-8076-3840fb2b6af7`; head `e52fb49`) + [paper-laya-decision-packet-scoreboard-sealed-fixture-v0.schema.json](paper-laya-decision-packet-scoreboard-sealed-fixture-v0.schema.json); CLI `python -m tools.paper_laya_decision_packet_scoreboard_sealed_fixture_v0`; [LAB_STATE.md](../LAB_STATE.md) §11s |
