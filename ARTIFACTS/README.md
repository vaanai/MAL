...
| [ORACLE-PHASE0-HANDOFF.md](ORACLE-PHASE0-HANDOFF.md) | Durable Phase-0 handoff: live inventory, JSONL vs Postgres, autonomy; access → [DEC-011](../DEC/DEC-011-cursor-oracle-access-cf-tunnel.md) |
