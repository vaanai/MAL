...
| **Status** | **Proposed** paper registration (2026-09-24). **Soft GATE PASS Formal-stamped** (Lyra; kill `bc-2fd452de-34a6-5c47-8076-3840fb2b6af7`; fix `bc-1908e01a-bed7-5580-b561-10eb7e67b9cd`; head `e52fb490589cc0246589edd2444f7d3f866c0c64`; [Soft GATE comment](https://github.com/vaanai/MAL/pull/68#issuecomment-5811344383); merged [PR #68](https://github.com/vaanai/MAL/pull/68) squash `d31af86` on `main`). Not a measure. Not run. |
...
| **Soft GATE** | **PASS** — Formal stamp Lyra (kill `bc-2fd452de-34a6-5c47-8076-3840fb2b6af7`; fix `bc-1908e01a-bed7-5580-b561-10eb7e67b9cd`; head `e52fb490589cc0246589edd2444f7d3f866c0c64`; [Soft GATE comment](https://github.com/vaanai/MAL/pull/68#issuecomment-5811344383); squash `d31af86` on `main`). Watches in [Soft watches](#soft-watches-non-blocking) stay **non-blocking** (`blocking=false`). |
