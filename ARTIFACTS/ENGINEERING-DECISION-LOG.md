...
| **Verification** | Soft GATE **PASS** Formal-stamped Lyra (kill `bc-aafaf4ca-d06f-5b11-b5cc-ca3f2ababd80`; head `6d238a141bc0d143815d2ac8eacc07dabe07aaec`; [Soft GATE comment](https://github.com/vaanai/MAL/pull/65#issuecomment-5809577563); Formal docs `38214ea` on `cursor/paper-laya-risk-gate-lock-receipt-v0-75e2`; [PR #65](https://github.com/vaanai/MAL/pull/65); `python3 -m unittest tools.test_paper_laya_risk_gate_lock_receipt_v0` — 22 OK per Soft GATE). |
| **Current state** | **Proposed** registration (Formal stamp on branch; merge pending). Not a measure. Not risk-gate unlock. Not LAYA authorize-run. Graph cold. Sealed book incomplete. `risk_gate.decision=locked`; `risk_gate.unlock=false`. |
