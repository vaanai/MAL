...
| **Verification** | Soft GATE **PASS** Formal-stamped Lyra (kill `bc-2fd452de-34a6-5c47-8076-3840fb2b6af7`; fix `bc-1908e01a-bed7-5580-b561-10eb7e67b9cd`; head `e52fb490589cc0246589edd2444f7d3f866c0c64`; [Soft GATE comment](https://github.com/vaanai/MAL/pull/68#issuecomment-5811344383); [PR #68](https://github.com/vaanai/MAL/pull/68)). |
| **Current state** | **Proposed** registration (Formal on branch; merge pending). Caps: `measure.kind=none`; sealed book **incomplete**; Graph **cold**; `risk_gate.decision=locked`; `risk_gate.unlock=false`; `laya.authorize_run=false`; `laya.live_trading=false`. |
